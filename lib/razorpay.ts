 ...
 * @param product - 'part1' or 'part2'
 * @param userEmail - User's email for the order
 * @returns Razorpay order object
 */
export async function createRazorpayOrder(product: 'part1' | 'part2', userEmail: string) {
 ...
 */
export function getProductPriceInINR(product: 'part1' | 'part2'): number {
