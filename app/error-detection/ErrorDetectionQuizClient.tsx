...
const markdownComponents = {
  ...
  th: ({ children, ...props }: React.ComponentPropsWithoutRef<"th">) => (
    <th
      className="border border-amber-300 bg-amber-100 px-4 py-2 font-bold text-amber-900 text-left text-[15px] md:text-[16px]"
      {...props}
    >
      {children}
    </th>
  ...
  td: ({ children, ...props }: React.ComponentPropsWithoutRef<"td">) => (
    <td
      className="border border-amber-200 px-4 py-2 text-gray-700 text-[15px] md:text-[16px]"
      {...props}
    >
      {children}
    </td>
...
export default function ErrorDetectionQuizClient({
  ...
  return (
    <div className="min-h-screen bg-[#faf5ef] font-sans flex flex-col">
      {/* TOP HEADER */}
      ...
      <section ref={quizSectionRef} className={`bg-[#faf5ef] ${quizStarted ? "" : "pt-12 pb-16"}`}>
        {!quizStarted ? (
          ...
          <div className="border-t border-slate-200">
            ...
            <div className="flex flex-col bg-slate-50" style={{ height: "calc(100vh - 96px)" }}>
