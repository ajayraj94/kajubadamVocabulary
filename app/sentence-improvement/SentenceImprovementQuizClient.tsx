              ...
              <main className="flex-1 flex flex-col lg:flex-row p-2 md:p-4 gap-3 md:gap-4 min-h-0">
                ...
                <div className="lg:hidden fixed bottom-5 right-5 z-50">
                    <button
                        ...
                        className="bg-[#0d7a3e] text-white w-12 h-12 rounded-full shadow-lg flex items-center justify-center hover:bg-[#0a5e2e] transition-all active:scale-90"
                    >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {showMobileStats && (
                    <div className="lg:hidden fixed inset-0 z-50 flex justify-end">
                        ...
                        <div className="relative w-[280px] bg-white shadow-xl overflow-y-auto p-4 animate-in slide-in-from-right">
                            ...
                            <div className="bg-emerald-50 border border-emerald-100 rounded p-2 text-center mb-4">
                                <span className="block text-[9px] text-emerald-700 font-bold uppercase tracking-wider">Score</span>
                                <span className={`block text-xl font-black my-0.5 ${totalScore >= 0 ? "text-emerald-800" : "text-red-600"}`}>{totalScore.toFixed(2)}</span>
                            ...
                            <div className="grid grid-cols-10 gap-[2px] justify-items-center mb-4">
                                {questions.map((q, idx) => {
                                    ...
                                    if (isActive) circleClass = "bg-[#0d7a3e] text-white ring-2 ring-emerald-300";
